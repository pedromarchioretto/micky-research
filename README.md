...
A base M.I.C.K.Y. utiliza uma estrutura de perfis de alumínio industrial 4040 e um sistema de tração baseado em rodas Mecanum. Embora o hardware inclua 6 motores, a configuração de software e cinemática utiliza 4 motores ativos para locomoção.
